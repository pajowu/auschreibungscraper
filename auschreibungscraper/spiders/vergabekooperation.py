...
class VergabekooperationSpider(scrapy.Spider):
    ...
    start_urls = [
        "https://vergabekooperation.berlin/NetServer/PublicationSearchControllerServlet?Max=1&function=SearchPublications&Gesetzesgrundlage=All&Category=PriorInformation&thContext=preinformations",
        "https://vergabekooperation.berlin/NetServer/PublicationSearchControllerServlet?Max=1&function=SearchPublications&Gesetzesgrundlage=All&Category=InvitationToTender&thContext=publications",
        "https://vergabekooperation.berlin/NetServer/PublicationSearchControllerServlet?Max=1&function=SearchPublications&Gesetzesgrundlage=All&Category=ContractAward&thContext=awardPublications",
    ]
    ...
    def parse_detail(self, response):
        ...
        yield response.follow(download_url, callback=self.parse_detail_2)
    ...
    def parse_detail_2(self, response):
        data = {"attachment_versions": [], "messages": []}
    ...
    def parse_dataprovider_filetree(self, response):
        ...
        yield {"FileTree": response_json, "file_urls": file_urls}
